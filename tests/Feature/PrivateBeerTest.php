...
//            ->assertJson($beer->toArray());
    ...
    public function test_user_can_be_deleted()
    {
        ...
        $userOneBeer = Beer::factory()->create();
        $userTwoBeer = Beer::factory()->create();
        $userOneRating = Rating::factory()->create(['user_id' => $userOne->id, 'beer_id' => $userOneBeer->id]);
        $userTwoRating = Rating::factory()->create(['user_id' => $userTwo->id, 'beer_id' => $userTwoBeer->id]);
